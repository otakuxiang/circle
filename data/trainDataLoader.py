...
import numpy as np
import torch
from data.data_utils import scene_cube
import cv2
...
class NoisyOtherMatterPortDataset(data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        structures = self.octree.get_structure(gt_points,L = self.layer - 1,expand=self.expand)


        return points,normals,structures,gt_points,gt_normals,min_bound