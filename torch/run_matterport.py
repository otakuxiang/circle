...
if __name__ == '__main__':
    ...
    h = 512
    w = 640
    # the folder which contains the noisy points generated by add_noise.py, so it should be same as tar_root in add_noise.py
    data_dir = "/home/chx/nas/other_disk/CVPR2022CIRCLE/noisy_depth/"

    
    # this is the folder where output will be stored, feel free to change it
    ...
    # the noisy points generated by add_noise.py, so it would be like "noisy_points_{sample_ratio}_{noise_level}.ply"
