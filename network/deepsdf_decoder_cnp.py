...
class Model(nn.Module):
    def __init__(self, position_size,latent_size, dims, dropout=None, dropout_prob=0.0, norm_layers=(), latent_in=(), weight_norm=False):
        """
        ...
        dims = [latent_size + position_size] + dims + [1]
        # print(dims)
